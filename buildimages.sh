...
docker build -t $images_name:$images_version_next .
docker rmi $images_name":latest"
docker tag $images_name:$images_version_next $images_name":latest"
docker push $images_name:$images_version_next
